...
export async function seedDemoShopData(companyId: string, userId: string) {
  ...
  // 3. Seed Suppliers
  const suppliers = [
    { id: 'sup_demo_01', name: 'TechDistributors East Africa', email: 'orders@techdistributors.co.ke', phone: '+254 711 000111', rating: 'A+', leadTimeDays: 3, address: 'Industrial Area, Nairobi' },
    { id: 'sup_demo_02', name: 'Global Display Logistics', email: 'sales@globaldisplay.com', phone: '+254 722 000222', rating: 'A', leadTimeDays: 5, address: 'Mombasa Port Rd' },
    { id: 'sup_demo_03', name: 'Silicon Core Imports', email: 'supply@siliconcore.io', phone: '+254 735 333444', rating: 'B+', leadTimeDays: 7, address: 'Eldoret Logistics Hub' }
  ];
  ...
  // 4. Seed Products (Rich cost/price structure for Profit, ABC/XYZ, and Turnover calculations)
  const products = [
    {
      id: 'prod_demo_01',
  ...
  const purchaseOrders = [
    {
      ...
      totalAmount: 1850.00,
      items: [
        { productId: 'prod_demo_01', name: 'Wireless Ergonomic Vertical Mouse', quantity: 50, unitCost: 20.00, totalCost: 1000.00 },
        { productId: 'prod_demo_05', name: 'USB-C 10-in-1 Multiport Hub', quantity: 34, unitCost: 25.00, totalCost: 850.00 }
      ]
    },
    {
      id: 'po_demo_02',
      ...
      totalAmount: 3300.00,
      items: [
        { productId: 'prod_demo_03', name: 'UltraHD 4K 27" IPS Monitor', quantity: 15, unitCost: 220.00, totalCost: 3300.00 }
      ]
    },
    {
      id: 'po_demo_03',
      ...
      totalAmount: 2100.00,
      items: [
        { productId: 'prod_demo_07', name: 'High-Speed 2TB NVMe M.2 SSD', quantity: 20, unitCost: 105.00, totalCost: 2100.00 }
      ]
    }
  ];
